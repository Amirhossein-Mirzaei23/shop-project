<template>
    <div class="container w-full h-screen bg-slate-400 bg-opacity-60 rounded-3xl">
<section class="h-72 w-11/12 bg-opacity-40 rounded-xl bg-zinc-50 mx-auto mt-3 grid grid-rows-5 items-center">
