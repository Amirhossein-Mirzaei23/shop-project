...
<template>
  <div ref="slider" class="custom-slider minmax flex">
    <input
    class=""
      type="range"
      name="min"
  ...
  <div class="minmax-inputs translate-y-5">
   <p>min: </p> <input type="number" ref="minvalueInput" :step="step" v-model="sliderMinValue" />
   <h1>max: </h1> <input type="number" :step="step" v-model="sliderMaxValue" />
  </div>
</template>
<style>
